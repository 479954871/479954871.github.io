        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch(msg.what) {
                case -1:
                    ...
                    if (result == SMSSDK.RESULT_COMPLETE) {
                        ...
                        if (event == SMSSDK.EVENT_SUBMIT_VERIFICATION_CODE) {
                            //验证码验证成功
                            HospitalServer.sendSignUpRequest(editTextNumber.getText().toString(), editTextPassword.getText().toString(), new HospitalServer.SignUpCallback() {
                                @Override
                ...
                case 1:
                    ...
                    break;
                case 2:
                    Toast.makeText(SignUpActivity.this, "网络不可用，请检查网络", Toast.LENGTH_SHORT).show();
                    break;
            }
